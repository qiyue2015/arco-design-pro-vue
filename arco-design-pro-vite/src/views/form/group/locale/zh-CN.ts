export default {
  ...
  'groupForm.title.assets': '素材与图标',
  'groupForm.form.label.icon': '功能图标',
  'groupForm.form.label.cover': '封面图片',
  'groupForm.form.label.gallery': '内容配图（最多 2 张）',
  'groupForm.form.label.banner': '横幅图片（最多 2 张）',
