export default {
  ...
  'groupForm.title.assets': 'Media and Icon',
  'groupForm.form.label.icon': 'Feature Icon',
  'groupForm.form.label.cover': 'Cover Image',
  'groupForm.form.label.gallery': 'Content Images (Up to 2)',
  'groupForm.form.label.banner': 'Banner Images (Up to 2)',
